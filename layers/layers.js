...
//ol.proj.get("EPSG:9473").setExtent([1027436.153137, -4165780.220407, 1090647.965373, -4132529.618234]);
var wms_layers = [];
...
var format_ParcelBoundary_17 = new ol.format.GeoJSON();
var features_ParcelBoundary_17 = format_ParcelBoundary_17.readFeatures(json_ParcelBoundary_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:9473'});
var jsonSource_ParcelBoundary_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ParcelBoundary_17.addFeatures(features_ParcelBoundary_17);
var lyr_ParcelBoundary_17 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ParcelBoundary_17, 
                style: style_ParcelBoundary_17,
                popuplayertitle: "Parcel Boundary",
                interactive: true,
                title: '<img src="styles/legend/ParcelBoundary_17.png" /> Parcel Boundary'
            });
var format_TopLeadsZoned_18 = new ol.format.GeoJSON();
var features_TopLeadsZoned_18 = format_TopLeadsZoned_18.readFeatures(json_TopLeadsZoned_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:9473'});
var jsonSource_TopLeadsZoned_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TopLeadsZoned_18.addFeatures(features_TopLeadsZoned_18);
var lyr_TopLeadsZoned_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TopLeadsZoned_18, 
                style: style_TopLeadsZoned_18,
                popuplayertitle: "Top Leads (Zoned)",
                interactive: true,
                title: '<img src="styles/legend/TopLeadsZoned_18.png" /> Top Leads (Zoned)'
            });
var group_Parcel = new ol.layer.Group({
                                layers: [lyr_ParcelBoundary_17,lyr_TopLeadsZoned_18,],
                                fold: "open",
                                title: "Parcel"});
...
lyr_ParcelBoundary_17.set('fieldAliases', {'fid': 'fid', 'PARCEL_PFI': 'PARCEL_PFI', 'PARCEL_SPI': 'PARCEL_SPI', 'PC_LGAC': 'PC_LGAC', 'PC_PLANNO': 'PC_PLANNO', 'PC_LOTNO': 'PC_LOTNO', 'PARC_ACCLT': 'PARC_ACCLT', 'PC_ALL': 'PC_ALL', 'PC_BLK': 'PC_BLK', 'PC_PNUM': 'PC_PNUM', 'Gross HA': 'Gross HA', });
lyr_TopLeadsZoned_18.set('fieldAliases', {'Gross HA': 'Gross HA', 'LGA': 'LGA', 'ZONE_CODE': 'ZONE_CODE', 'Zone 1 Ha': 'Zone 1 Ha', 'NDH.': 'NDH.', 'Address': 'Address', 'Lead Link': 'Lead Link', 'P_Lot size': 'P_Lot size', });
...
lyr_ParcelBoundary_17.set('fieldImages', {'fid': 'TextEdit', 'PARCEL_PFI': 'TextEdit', 'PARCEL_SPI': 'TextEdit', 'PC_LGAC': 'TextEdit', 'PC_PLANNO': 'TextEdit', 'PC_LOTNO': 'TextEdit', 'PARC_ACCLT': 'TextEdit', 'PC_ALL': 'TextEdit', 'PC_BLK': 'TextEdit', 'PC_PNUM': 'TextEdit', 'Gross HA': 'TextEdit', });
lyr_TopLeadsZoned_18.set('fieldImages', {'Gross HA': 'TextEdit', 'LGA': 'TextEdit', 'ZONE_CODE': 'TextEdit', 'Zone 1 Ha': 'TextEdit', 'NDH.': 'TextEdit', 'Address': '', 'Lead Link': '', 'P_Lot size': '', });
...
lyr_ParcelBoundary_17.set('fieldLabels', {'fid': 'no label', 'PARCEL_PFI': 'no label', 'PARCEL_SPI': 'no label', 'PC_LGAC': 'no label', 'PC_PLANNO': 'inline label - visible with data', 'PC_LOTNO': 'inline label - visible with data', 'PARC_ACCLT': 'no label', 'PC_ALL': 'no label', 'PC_BLK': 'no label', 'PC_PNUM': 'no label', 'Gross HA': 'inline label - always visible', });
lyr_TopLeadsZoned_18.set('fieldLabels', {'Gross HA': 'inline label - visible with data', 'LGA': 'inline label - visible with data', 'ZONE_CODE': 'inline label - visible with data', 'Zone 1 Ha': 'header label - visible with data', 'NDH.': 'inline label - visible with data', 'Address': 'inline label - visible with data', 'Lead Link': 'inline label - visible with data', 'P_Lot size': 'inline label - always visible', });
lyr_TopLeadsZoned_18.on('precompose', function(evt) {
